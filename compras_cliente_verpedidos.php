...
<?php
  ...
  $q = mysql_query("SELECT * FROM t_pedido WHERE id_cliente='".$_SESSION["usr_email"]."'");
    ...
    <div class="content uploadertienda">
     ...
     <form class="form-horizontal" method="POST" enctype="multipart/form-data">
      ...
      <div class="well">
        <h3>Instrucciones:</h3>
        <ol>
          <li>Sube la imagen que deseas imprimir. Asegúrate de que tiene suficiente resolución para imprimirlo en el tamaño que deseas.</li>
      ...
      <div class="form-actions">
        ...
        <button class="btn btn-primary incluyepedido pull-right"><i class="icon-shopping-cart icon-white"></i> Añadir al carrito</button>
