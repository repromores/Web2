...
function phpconsole_settings() {
    ...
    */
    ...
    $domain = '.mores.com'; // don't forget to use leading dot, like so: .your-domain.com

    $users[] = array('monxas', 'Gv9vCTaEKQR28UD37aHiuZsSSsg4BfL3hYKise4B3EVyE13l6ILwrSvI3mUtG7gU', 'OjaakEZVmJrEEMK6uH7RvR5nzyVDTKsrJYBA3DTXKJSguvccvZqOn2jhOhGqnKYA');
