...
<div><div class="adM">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <td width="100%" valign="middle" align="left" style="line-height:16px">
                                      <p style="margin-top:0;margin-bottom:0"> <font style="font-size:11px;font-family:Verdana;font-weight:normal">El usuario <b><a href="mailto:'.$_SESSION["usr_email"].'" target="_blank">'.$_SESSION["usr_email"].'</a></b>
                                          ha modificado sus datos en el
                                          Sistema de Envios.<br>
                                        </font> </p>
                                    </td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    <td width="100%" valign="middle" align="left" style="line-height:18px">
                                      <p style="margin-top:0;margin-bottom:0"> <font style="font-family:Verdana;font-size:11px;font-weight:bold;color:#858585"> Dpto. de
                                          ...
                                          <a href="mailto:informatica@mores.es" style="color:#858585;text-decoration:none" target="_blank">
      ...
      <div style="font-family:Sans-serif;font-size:10px">
        ...
        <p> Tiene a su disposición el compromiso de Cadena de Custodia
          ...
          siguiente enlace: <a style="text-decoration:none" href="http://www.mores.es/cadenaCustodia/compromisoDireccion.pdf" target="_blank">Cadena
