                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <td width="100%" valign="middle" align="left" style="line-height:18px">
                                      <p style="margin-top:0;margin-bottom:0"> <font style="font-size:11px;font-family:Verdana;font-weight:normal"> Estimado cliente: </font> </p>
                                    </td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    <td width="100%" valign="middle" align="left" style="line-height:16px">
                                      <p style="margin-top:0;margin-bottom:0"> <font style="font-size:11px;font-family:Verdana;font-weight:normal">Datos de su pedido:<br>
                                          Descripcion:<br>
                                          <b>"'.$text.'"</b><br>
                                          <br>
