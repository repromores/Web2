...
<?php
  if(!isLogged()){  header('Location: login2.php?goto=tienda_fotopvc.php');};
...
<?php include "inc/menu.php"; ?>
  ...
  <div class="span10">
    ...
    <ul class="breadcrumb">
      ...
      <li><a href="tienda_fotopvc_info.php">Foto en PVC</a> <span class="divider">/</span></li>
      <li class="active">Pedir foto en PVC</li>
    </ul>
     <form class="form-horizontal" method="POST" enctype="multipart/form-data">
      ...
      <input type="hidden" name="tipo" id="tipo" value="fotopvc">
      <input type="hidden" name="nombre" id="nombre" value="FOTOPVC">
      <input type="hidden" name="material" id="material" value="pvc">
      <input type="hidden" name="producto" id="producto" value="fotopvc">
