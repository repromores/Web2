...
<?php
  if(!isLogged()){  header('Location: login2.php?goto=tienda_vinilometacrilato.php');};
  $masdatos = empty($_SESSION["usr_apellidos"])? true : false;
?>
<?php include "inc/head.php"; ?>
<title>morés - vinilo en metacrilato</title>
<?php
  $producto = "vinilometacrilato";
  // $h1text : variable para fijar el H1 en cada pagina para hacerlo único y aprovechar mejor el SEO
  $h1text = "Vinilo en metacrliato - morés";
...
<?php include "inc/menu.php"; ?>
  ...
  <div class="span10">
    <div class="content uploadertienda">
      ...
      <h2>Vinilo en metacrliato</h2>
    <ul class="breadcrumb">
      <li><a href="index.php">Inicio</a> <span class="divider">/</span></li>
      <li><a href="tienda.php">Tienda</a> <span class="divider">/</span></li>
      <li><a href="tienda_vinilometacrilato_info.php">Vinilo en metacrilato</a> <span class="divider">/</span></li>
      <li class="active">Pedir Vinilo en metacrilato</li>
    </ul>
     <form class="form-horizontal" method="POST" enctype="multipart/form-data">
      ...
      <input type="hidden" name="tipo" id="tipo" value="vinilometacrilato">
      <input type="hidden" name="nombre" id="nombre" value="Vinilometacrilato">
      <input type="hidden" name="material" id="material" value="metacrilato">
      <input type="hidden" name="producto" id="producto" value="vinilometacrilato">
