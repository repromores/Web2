...
<title>morés - Utilidades</title>
<?php
  // $h1text : variable para fijar el H1 en cada pagina para hacerlo único y aprovechar mejor el SEO
  $h1text = "Utilidades - morés";
 ?>
...
<li>Configuraci&oacute;n de AutoCad (PLT): <a href="utilidades/instrucciones-autocad-plt.pdf">instrucciones-autocad-plt.pdf</a></li>
</ul>

<strong>Perfiles</strong>
<ul>
<li>Espacio de trabajo de Mor&eacute;s: <a href="utilidades/perfil-espacio-trabajo-mores.zip">perfil-espacio-trabajo-mores.zip</a></li>
<li>Fotograf&iacute;a (Frontier): <a href="utilidades/perfil-fotografia-frontier-icc.zip">perfil-fotografia-frontier-icc.zip</a> </li>
</ul>

<strong>Utilidades</strong>
<ul>
<li>Mor&eacute;s-PDF: <a href="utilidades/impresora-mores-pdf.exe">impresora-mores-pdf.exe</a></li>
